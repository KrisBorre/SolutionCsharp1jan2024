...
namespace WinFormsKeplerEllipticOrbit3jan2024
{
    public partial class Form1 : Form
    {
        ...
        private void Calculate(double eccentricity)
        {
            ...
            ISolver solver = new DifferentialEquationsSolver1jan2024(new DifferentialEquationsKepler(), Method.RK61 | Method.Sophisticated);
            ...
            solver.Solve(initialCondition: ic, number_of_steps: number_of_steps, out double delta_x, out NumericalSolutions solutions, number_of_solutions: (int)number_of_steps, interval: interval, x_end: interval);
