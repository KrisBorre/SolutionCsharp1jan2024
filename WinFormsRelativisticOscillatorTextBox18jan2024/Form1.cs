...
namespace WinFormsRelativisticOscillatorTextBox18jan2024
{
    public partial class Form1 : Form
    {
        ...
        private void Calculate(double ratio)
        {
            ...
            var problem = new DifferentialEquationsRelativisticOscillator(spring_configuration: spring_configuration, mass_configuration: mass_configuration);
