...
namespace LibraryDifferentialEquationKepler2jan2024
{
    internal class DifferentialEquation1 : DifferentialEquationBaseClass
    {
        ...
        public DifferentialEquation1(MassExoplanetManager mass_exoplanet_manager, MassStarManager mass_star_manager, ParameterConfiguration mass_exoplanet_configuration = ParameterConfiguration.Constant, ParameterConfiguration mass_star_configuration = ParameterConfiguration.Constant)
        {
