...
{
    internal class DifferentialEquation4 : DifferentialEquationBaseClass
    {
        private MassExoplanetManager mass_exoplanet_manager;
        private MassStarManager mass_star_manager;

        public DifferentialEquation4(MassExoplanetManager mass_exoplanet_manager, MassStarManager mass_star_manager, ParameterConfiguration mass_exoplanet_configuration = ParameterConfiguration.Constant, ParameterConfiguration mass_star_configuration = ParameterConfiguration.Constant)
        {
        ...
        public override double function(double interval, double x, params double[] y)
        {
            ...
            return -(y[1] * mass * Mass) / Math.Pow(y[0] * y[0] + y[1] * y[1], 1.5);
        }
    }
}
