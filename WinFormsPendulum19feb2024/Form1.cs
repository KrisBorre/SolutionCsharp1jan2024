...
namespace WinFormsPendulum19feb2024
{
    public partial class Form1 : Form
    {
        ...
        private void Calculate()
        {
            ...
            var problem = new DifferentialEquationsPendulum(gravity_configuration: gravity_configuration, length_configuration: length_configuration, mass_configuration: mass_configuration);
        ...
        private void Form1_SizeChanged(object sender, EventArgs e)
        {
            ...
            if (this.plotViews != null)
            {
                for (int i = 0; i < this.numberOfPlots; i++)
                {
                    ...
                    {
                        plotViews[i].Size = new Size(width, (height - 40) / this.numberOfPlots);
                        plotViews[i].Location = new Point(0, 40 + i * ((height - 40) / this.numberOfPlots));
                    }
                }
            }
        }
